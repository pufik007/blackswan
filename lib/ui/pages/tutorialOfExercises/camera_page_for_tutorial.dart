...
import 'dart:async';
import '../../camera_alt/camera.dart';
import '../../camera_alt/bndbox.dart';
...
import '../../camera_alt/vp_tree_manager.dart';
import '../../camera_alt/exercises_counter.dart';
import '../../camera_alt/pose_space_point.dart';
import '../../camera_alt/bbox.dart';
import '../../camera_alt/pose_joint_lib.dart';
...
class CameraPageTutorial extends StatefulWidget {
  ...
  const CameraPageTutorial(this.cameras);

  _CameraPredictionPageState createState() => new _CameraPredictionPageState();
}

class _CameraPredictionPageState extends State<CameraPageTutorial> {
...
// ['A', 0.0077], ['B', 0.1793]
  ...
  _startTimerExercises(exercises) {
    if (exercises['duration'] != null && exercises['duration'] != 0) {
      _counterExercise = exercises['duration'];
    } else {
      if (exercises['numberOfReps'] != null && exercises['numberOfReps'] != 0) {
        _counterExercise = exercises['numberOfReps'] * 5;
      } else {
        _counterExercise = 12;
      }
    }
  ...
  Widget createExerciseTimerOrEndLevel(BuildContext context, exercises) {
      ...
      body: Stack(
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              createExerciseTimerOrEndLevel(context, exercises),
            ],
          ),
        ],
      ),
