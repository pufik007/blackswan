...
// ['A', 0.0077], ['B', 0.1793]
    ...
    List<List<double>> posePersonFrameUp1 = [
      [0.518837034702301, 0.21762694418430328],
      [0.5936756730079651, 0.29093241691589355], 
      [0.43650341033935547, 0.29800519347190857],
      [0.6734507083892822, 0.36839064955711365], 
      [0.3584330379962921, 0.39318305253982544], 
      [0.638171911239624, 0.365553081035614], 
      [0.38704797625541687, 0.3610818386077881],
      [0.5885904431343079, 0.46902474761009216], 
      [0.4659067988395691, 0.47433051466941833],
      [0.6218144297599792, 0.5466298460960388],
      [0.3929615914821625, 0.5188540816307068], 
      [0.6294669508934021, 0.6011330485343933],
      [0.3366778492927551, 0.6122499704360962]
    ];
    List<double> confidencePersonFrameUp1 = [
      0.9409452676773071, 
      0.9738365411758423, 
      0.9713674187660217, 
      0.5399097800254822, 
      ...
      0.57377028465271, 
      0.7417255640029907, 
      0.010766980238258839, 
      0.09038764983415604, 
      0.0026877219788730145, 
      0.0017628537025302649
    ];
    Bbox bboxPersonFrameUp1;

    List<List<double>> posePersonFrameDown = [
      [0.5440866351127625, 0.38722342252731323], 
      [0.6400344371795654, 0.4315575957298279], 
      [0.49327704310417175, 0.46596285700798035], 
      [0.6774806976318359, 0.5254921317100525], 
      [0.4313621520996094, 0.5424965620040894], 
      [0.5118936896324158, 0.47621241211891174], 
      [0.364897757768631, 0.5833577513694763],
      [0.6663459539413452, 0.5397263169288635], 
      [0.48602110147476196, 0.5951047539710999], 
      [0.665123462677002, 0.535617470741272], 
      [0.39847761392593384, 0.57671058177948], 
      [0.6313252449035645, 0.6357288956642151], 
      [0.36645469069480896, 0.6379084587097168]
    ];
    List<double> confidencePersonFrameDown = [
      0.9978346228599548, 
      0.9704302549362183, 
      0.9461008310317993, 
      0.7131601572036743, 
    ...
    Bbox bboxPersonFrameDown;

    List<List<double>> posePersonFrameUp2 = [
      [0.5849891901016235, 0.20755799114704132], 
      [0.6530285477638245, 0.2777823805809021], 
      [0.4964475631713867, 0.2726478576660156], 
      [0.7219987511634827, 0.36702629923820496], 
      [0.44512417912483215, 0.36276277899742126], 
      [0.6604878306388855, 0.34060853719711304], 
      [0.5142624974250793, 0.34322431683540344], 
      [0.6140568852424622, 0.4353316128253937], 
      [0.5142113566398621, 0.4323936998844147], 
      [0.6955285668373108, 0.5338819622993469], 
      [0.4321783483028412, 0.5283318161964417], 
      [0.7669612765312195, 0.6618530750274658], 
      [0.32280346751213074, 0.6535694599151611]
    ];
    List<double> confidencePersonFrameUp2 = [
      0.9969004988670349, 
      0.99080491065979, 
      0.988034188747406, 
      0.9858855605125427, 
    ...
    Bbox bboxPersonFrameUp2;


    var counter = ExercisesCounter(vpTreeManager, exerciseKey,
        thresholdDistance, thresholdCount, pattern);

    counter.repsCounter(posePersonFrameUp1, confidencePersonFrameUp1, bboxPersonFrameUp1);
    counter.repsCounter(posePersonFrameUp1, confidencePersonFrameUp1, bboxPersonFrameUp1);
    counter.repsCounter(posePersonFrameDown, confidencePersonFrameDown, bboxPersonFrameDown);
    counter.repsCounter(posePersonFrameDown, confidencePersonFrameDown, bboxPersonFrameDown);
    counter.repsCounter(posePersonFrameUp1, confidencePersonFrameUp1, bboxPersonFrameUp1);
      var repsCount = 
        counter.repsCounter(posePersonFrameUp1, confidencePersonFrameUp1, bboxPersonFrameUp1);
